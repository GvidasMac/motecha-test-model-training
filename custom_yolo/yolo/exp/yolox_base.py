...
class Exp(BaseExp):
    def __init__(self):
        ...
        self.data_dir = "/Users/gvmaka/projects/energesman-waste-detection-and-classification/dataset"
        # name of annotation file for training
        self.train_ann = "instances_train.json"
        # name of annotation file for evaluation
        self.val_ann = "instances_val.json"
        # name of annotation file for testing
        self.test_ann = "instances_val.json"
        ...
        self.translate = 0.0
        self.mosaic_scale = (0.1, 0.1)
        # apply mixup aug or not
        self.enable_mixup = False
        self.mixup_scale = (0.1, 0.1)
    ...
    def get_model(self):
        from yolo.models import YOLOX, YOLOPAFPN, YOLOXHead
    ...
    def get_dataset(self, cache: bool = False, cache_type: str = "ram"):
        ...
        """
        from yolo.data import COCODataset, TrainTransform
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=False, cache_img: str = None):
        ...
        from yolo.utils import wait_for_the_master
    ...
    def get_lr_scheduler(self, lr, iters_per_epoch):
        from yolo.utils import LRScheduler
    ...
    def get_eval_dataset(self, **kwargs):
        from yolo.data import COCODataset, ValTransform
    ...
    def get_evaluator(self, batch_size, is_distributed, testdev=False, legacy=False):
        from yolo.evaluators import COCOEvaluator
